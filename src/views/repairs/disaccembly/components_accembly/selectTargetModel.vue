...
const emits = defineEmits("handleTargetSelect");
...
function handleSelect() {
  console.log('From selectTargetModel: ', state.selectedDevice);
  emits("handleTargetSelect", state.selectedDevice);
