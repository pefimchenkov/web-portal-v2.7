...
export default {
  ...
  async created() {
    const plans = this.$store.dispatch('FETCH_PLANS', 5)
    const income = this.$store.dispatch('FETCH_INCOME', 5)
    const fact = this.$store.dispatch('FETCH_FACT', 5)
